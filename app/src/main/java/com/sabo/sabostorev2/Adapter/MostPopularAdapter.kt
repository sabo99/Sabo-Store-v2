...
class MostPopularAdapter(private val context: Context, private val itemsModelList: List<ItemsModel>): RecyclerView.Adapter<MostPopularAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_popular, parent, false))
    }
